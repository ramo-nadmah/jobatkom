        ...
        <div class="row">
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-container">
                    ...
                    <form action="/search-task" method="get">
                    @csrf
            ...
            <div class="col-xl-9 col-lg-8 content-left-offset">
                ...
                @foreach($tasks as $task)
                    <!-- Job Listing -->
                        <a href="task={{$task->id}}" class="job-listing">

                            <!-- Job Listing Details -->
                            <div class="job-listing-details">
                                <!-- Logo -->
                                <div class="job-listing-company-logo">
                                    <img src="{{$task->employer->logo}}" alt="">
                                </div>

                                <!-- Details -->
                                <div class="job-listing-description">
                                    <h4 class="job-listing-company">{{$task->employer->name}}</h4>
                            ...
                            <div class="job-listing-footer">
                                <ul>
                                    @php
                                        ...
                                        $datework = new \Carbon\Carbon($task->updated_at);
                                        $now = \Carbon\Carbon::now();
                                        $diff = $datework->diffInDays($now);
                                    @endphp
                                    <li><i class="icon-material-outline-business-center"></i> {{$task->skills}}</li>
                                    <li><i class="icon-material-outline-account-balance-wallet"></i> ${{number_format($task->min_budget)}}-${{number_format($task->max_budget)}}</li>
